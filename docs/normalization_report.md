# Normalization Report — Urban Smart Parking System (USPS)

## Overview

All relations in the USPS relational schema are normalized up to **Third Normal Form (3NF)**. This report documents the functional dependencies (FDs) for each table and explains why it satisfies 1NF, 2NF, and 3NF.
